$(function () {
  ...
  <div class="py-8 space-y-6">
      ...
      <div class="flex justify-center items-center gap-x-2 text-gray-on-bg text-sm item-middle">
          <button type="button" class="rounded-md bg-primary-dark px-2.5 py-1.5 text-sm text-white shadow-sm hover:bg-white/5">Back to the top</button>
          • 
          <button type="button" class="rounded-md bg-primary-dark px-2.5 py-1.5 text-sm  text-white shadow-sm hover:bg-white/5">
          About</button>
          • 
          <button type="button" class="rounded-md bg-primary-dark px-2.5 py-1.5 text-sm  text-white shadow-sm hover:bg-white/5">Contact</button>
